            ...
            <div class="d-flex w-100 flex-center p-15">
                <div class="login-wrapper">
                    ...
                    <div class="text-dark-75">
                        ...
                        <h3 class="mb-8 mt-22 font-weight-bold">Welcome to Try Ryda platform</h3>
                        ...
                        <form class="form text-left" id="kt_login_signin_form" method="POST" action="{{ route('login') }}">
                           @csrf
                            <div class="form-group py-2 m-0">
                                <input class="form-control h-auto border-0 px-0 placeholder-dark-75" value="{{ old('enauk') }}" type="text" placeholder="Email Address" name="email" autocomplete="off" />
                                @error('email')
